...
const anime_es = require('./anime.es-9dd45a69.js');
...
const SallaProductsList = class {
  ...
  render() {
    ...
    if (this.showPlaceholder) {
      return index.h("div", { class: "s-products-list-placeholder" }, index.h("span", { innerHTML: ShoppingBag }), index.h("p", null, this.placeholderText));
    }
...
//# sourceMappingURL=salla-products-list.cjs.entry.js.map