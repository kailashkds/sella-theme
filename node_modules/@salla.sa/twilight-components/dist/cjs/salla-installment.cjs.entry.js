...
const SallaInstallment = class {
  ...
  render() {
    return (index.h(index.Host, null, this.tamaraIsActive ?
      index.h("div", { class: "tamara-product-widget", "data-price": this.price, "data-currency": this.currency, "data-lang": this.language, "data-payment-type": "installment" })
      : '', this.tabbyIsActive ?
...
//# sourceMappingURL=salla-installment.cjs.entry.js.map